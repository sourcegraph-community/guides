...
A curated, prompt‑first set of developer‑facing guides for running enterprise SDLC tasks with Amp. These guides are repository‑agnostic, assume your repo contains an AGENTS.md with team conventions, and avoid raw tool outputs—Amp selects methods automatically and returns synthesized results only.
...
2. Follow the phase guide(s) relevant to your task; paste prompts as "single messages" and iterate.
